...
/** Autogenerated input type of DeleteChoice */
...
/** Autogenerated return type of DeleteChoice */
export type DeleteChoicePayload = {
...
export type LoginInput = {
  autoLogin?: InputMaybe<Scalars['Boolean']>;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
...
export type LoginPayload = {
  ...
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  remindToken?: Maybe<Scalars['String']>;
};
...
export type Mutation = {
  ...
  removeChoice?: Maybe<DeleteChoicePayload>;
...
export type LogoutMutation = {
  __typename?: 'Mutation';
  logout?: { __typename?: 'LogoutPayload'; accessKey?: string | null } | null;
};
...
export type RemoveChoiceMutationVariables = Exact<{
  id: Scalars['Int'];
}>;

export type RemoveChoiceMutation = {
  __typename?: 'Mutation';
  removeChoice?: { __typename?: 'DeleteChoicePayload'; id: number } | null;
};
...
export type AddChoiceMutationOptions = Apollo.BaseMutationOptions<
  ...
  AddChoiceMutationVariables
>;
export const RemoveChoiceDocument = gql`
...
`;
export type RemoveChoiceMutationFn = Apollo.MutationFunction<
  RemoveChoiceMutation,
  RemoveChoiceMutationVariables
>;
 ...
 * });
 */
export function useRemoveChoiceMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RemoveChoiceMutation,
    RemoveChoiceMutationVariables
  >,
  ...
  return Apollo.useMutation<
    RemoveChoiceMutation,
    RemoveChoiceMutationVariables
  >(RemoveChoiceDocument, options);
}
export type RemoveChoiceMutationHookResult = ReturnType<
  typeof useRemoveChoiceMutation
>;
export type RemoveChoiceMutationResult =
  Apollo.MutationResult<RemoveChoiceMutation>;
export type RemoveChoiceMutationOptions = Apollo.BaseMutationOptions<
  RemoveChoiceMutation,
  RemoveChoiceMutationVariables
>;
